...
function writeToFile(fileName, answers) {
    ...
    svgString += "<g>";
    // Takes user input for shape chice and inserts it into SVG file
    ...
    // Usig file system module to generatesvg file, takes in file name given in the promptUser function, the svg string, and a ternary operator which handles logging any errors, or a "Generated logo.svg" message to the console  
